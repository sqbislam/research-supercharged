export const categories_cs = [
  ...
  },
  {
    ...
    value: 'cs.CR',
    description:
      'Covers all areas of cryptography and security including authentication, public key cryptosystems, proof-carrying code, etc. Roughly includes material in ACM Subject Classes D.4.6 and E.3.',
  },
  {
  ...
  },
  {
    ...
    value: 'cs.DC',
    description:
      'Covers fault-tolerance, distributed algorithms, stability, parallel computation, and cluster computing. Roughly includes material in ACM Subject Classes C.1.2, C.1.4, C.2.4, D.1.3, D.4.5, D.4.7, E.1.',
  },
  {
  ...
  },
  {
    ...
    value: 'cs.GR',
    description:
      'Covers all aspects of computer graphics. Roughly includes material in all of ACM Subject Class I.3, except that I.3.5 is likely to have Computational Geometry as the primary subject area.',
  },
  {
